package com.gant.binance.api.client.impl;

import com.gant.binance.api.client.BinanceApiAsyncRestClient;
import com.gant.binance.api.client.BinanceApiCallback;
import com.gant.binance.api.client.config.BinanceApiConfig;
import com.gant.binance.api.client.constant.BinanceApiConstants;
import com.gant.binance.api.client.domain.account.Account;
import com.gant.binance.api.client.domain.account.DepositAddress;
import com.gant.binance.api.client.domain.account.DepositHistory;
...
import com.gant.binance.api.client.domain.account.Order;
import com.gant.binance.api.client.domain.account.Trade;
import com.gant.binance.api.client.domain.account.TradeHistoryItem;
import com.gant.binance.api.client.domain.account.WithdrawHistory;
import com.gant.binance.api.client.domain.account.WithdrawResult;
import com.gant.binance.api.client.domain.account.request.AllOrdersRequest;
import com.gant.binance.api.client.domain.account.request.CancelOrderRequest;
import com.gant.binance.api.client.domain.account.request.CancelOrderResponse;
import com.gant.binance.api.client.domain.account.request.OrderRequest;
import com.gant.binance.api.client.domain.account.request.OrderStatusRequest;
import com.gant.binance.api.client.domain.event.ListenKey;
import com.gant.binance.api.client.domain.general.Asset;
import com.gant.binance.api.client.domain.general.ExchangeInfo;
import com.gant.binance.api.client.domain.general.ServerTime;
import com.gant.binance.api.client.domain.market.AggTrade;
import com.gant.binance.api.client.domain.market.BookTicker;
...
import com.gant.binance.api.client.domain.market.OrderBook;
import com.gant.binance.api.client.domain.market.TickerPrice;
import com.gant.binance.api.client.domain.market.TickerStatistics;

import java.util.List;

import static com.gant.binance.api.client.impl.BinanceApiServiceGenerator.createService;
